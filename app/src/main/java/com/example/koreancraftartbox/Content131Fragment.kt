...
import kotlinx.android.synthetic.main.fragment_content131.*
import kotlinx.android.synthetic.main.fragment_content131.view.myScrollView


class Content131Fragment: Fragment()  {
    companion object {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_content131, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val videoResources = listOf(R.raw.video7, R.raw.video8)
        ...
        rightButton22.setOnClickListener { replaceWithSecondFragment()
            CustomToast.cancelToast() }
    }

    private fun replaceWithSecondFragment() {
        requireActivity().supportFragmentManager.beginTransaction()
            .replace(R.id.detail_content_frame1, Content132Fragment())
            .addToBackStack(null)
            .commit()
    }
}