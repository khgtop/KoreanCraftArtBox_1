...
import kotlinx.android.synthetic.main.activity_content_detail222.*
import kotlinx.android.synthetic.main.custom_normal_toast_step4.toast_layout

class ContentDetailActivity222 : BaseActivity() {
    private val isOpenedList = mutableListOf(false, false)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_content_detail222)
        ...
        val imageList = mutableListOf<Int>(R.drawable.detail_2_2_3, R.drawable.detail_2_2_4)
