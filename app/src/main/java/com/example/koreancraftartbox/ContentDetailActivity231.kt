...
import kotlinx.android.synthetic.main.activity_content_detail231.*
import kotlinx.android.synthetic.main.custom_normal_toast_step4.toast_layout

class ContentDetailActivity231 : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_content_detail231)
        ...
        val imageList = mutableListOf<Int>(R.drawable.detail_2_3_5, R.drawable.detail_2_3_6, R.drawable.detail_2_3_7)
        ...
        val videoResources = listOf(R.raw.video14)
