...
import kotlinx.android.synthetic.main.fragment_content231.*
import kotlinx.android.synthetic.main.fragment_content231.view.myScrollView


class Content231Fragment: Fragment()  {
    companion object {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_content231, container, false)
    ...
    private fun replaceWithSecondFragment() {
        requireActivity().supportFragmentManager.beginTransaction()
            .replace(R.id.detail_content_frame2, Content232Fragment())
            .addToBackStack(null)
            .commit()
    }
}