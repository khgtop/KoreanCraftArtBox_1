...
import kotlinx.android.synthetic.main.activity_content_detail213.*
import kotlinx.android.synthetic.main.custom_normal_toast_step4.toast_layout

class ContentDetailActivity213 : BaseActivity() {
    private val isOpenedList = mutableListOf(false, false, false, false)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_content_detail213)
        ...
        val imageList = mutableListOf<Int>(R.drawable.detail_2_1_7, R.drawable.detail_2_1_8, R.drawable.detail_2_1_9)
        ...
        val videoResources = listOf(R.raw.video11)
