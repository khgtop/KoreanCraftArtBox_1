...
import kotlinx.android.synthetic.main.activity_content_detail212.*
import kotlinx.android.synthetic.main.custom_normal_toast_step4.toast_layout

class ContentDetailActivity212 : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_content_detail212)
        CustomToast.showToast(this, "아래로 스크롤 해주세요.", R.layout.custom_normal_toast_step4)
        val imageList = mutableListOf<Int>(R.drawable.detail_2_1_4, R.drawable.detail_2_1_5, R.drawable.detail_2_1_6)
        ...
        val videoResources = listOf(R.raw.video10)
